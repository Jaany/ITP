...
public class UpdateMaintenanceServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("bofore  id"+ request.getParameter("VehicleID"));
		String VehicleID = request.getParameter("VehicleID");
		
		repairandmaintenance.setRepairID(request.getParameter("RepairID"));
		repairandmaintenance.setRepairID(request.getParameter("VehicleID"));
		...
		System.out.println("after  id"+ request.getParameter("VehicleID"));
