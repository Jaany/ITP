		...
		<div class="row">
			...
			<div class="col-md-8 col-xl-9">
				<div class="card" style="height: 1000px;">
					<div class="card-header">
						<h5 class="card-title mb-0">Updating End_Date of String VehicleID=(String)request.getParameter("VehicleID")</h5>
				...
				<input type="text" class="form-control" id="exampleInputFName" placeholder="Vehicle ID"  name="VehicleID"    required     >
				<br>
