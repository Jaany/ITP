	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-8 col-xl-9">
				...
				<input type="text" class="form-control" id="exampleInputFName" placeholder="Vechile Id"  name="RepairID"   required>
				<br>
				
				<label>Vehicle ID</label>
				<input type="text" class="form-control" id="exampleInputFName" placeholder="Rate Id"  name="VehicleID"    required     >
				<br>
				...
				<input type="submit" class="btn btn-success "  value="ADD"  style="margin-left:500px;"><br>
...
$(".sub-menu a").click(function () {
 ...
 <table border="2">
    <caption><h3><center>Repair And Maintenance Details</center></h3></caption> 
			...
			<td><a href="Update_Maintenance_Details.jsp?VehicleID=<%=repairandmaintenance.getVehicleID() %>"><button >Select</button></a></td>
