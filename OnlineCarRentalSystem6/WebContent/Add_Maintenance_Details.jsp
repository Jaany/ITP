	...
	<div class="container">
		...
		<div class="row">
			...
			<!--  <label>Vehicle ID</label>-->	
				<input type="hidden" class="form-control" id="exampleInputFName" placeholder="Vehicle ID"  name="VehicleID "    required  pattern="[A-Za-z]{2}[0-9]{3}"   >
				<title>there is first 2 letters should be characters and next 3 should numerical value</title>
				<br>
				
				<label>Start Date</label>
				<input type="text" class="form-control" id="exampleInputPassword1" placeholder="date"  name="Start_Date"  required><br>
				
				<label>End Date</label>
				<input type="text" class="form-control" id="exampleInputPassword11" placeholder="date"  name="End_Date"  required><br>
