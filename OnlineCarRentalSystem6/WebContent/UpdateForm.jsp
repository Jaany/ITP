	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-8 col-xl-9">
				...
				<input type="submit" class="button "  value="Update" onclick="myFunction()" style="margin-left:500px;"><br>
	</form><br><br>
...
function myFunction() {
  ...
  alert("End_Date of  <%=repairandmaintenance.getVehicleID()%> is updated!");
}
</script>
