		...
		<div class="row">
			...
			<div class="col-md-8 col-xl-9">
				<div class="card" style="height: 1000px;">
					...
					<form action="UpdateMaintenanceSevlet?VehicleID=<%=repairandmaintenance.getVehicleID()%>" method="post">
	
          
				<label>Repair ID</label>
				<input type="text" class="form-control" id="exampleInputFName" placeholder="Repair ID"  name="RepairID"  value="<%=repairandmaintenance.getRepairID()%>" required>
				<br>
				
				<label>Vehicle ID</label>
				<input type="text" class="form-control" id="exampleInputFName" placeholder="Vehicle ID"  name="VehicleID"  value="<%=repairandmaintenance.getVehicleID()%>"  required     >
				<br>
				
				
				<label>Start Date</label>
				<input type="date" class="form-control" id="exampleInputPassword1" placeholder="date"  name="Start_Date" value="<%=repairandmaintenance.getStart_Date()%>" required><br>
				...
				<input type="text" class="form-control" id="exampleInputPassword1" placeholder="Description"  name="Description" value="<%=repairandmaintenance.getDescription()%>" required><br>
				
				<label>Maintenance Cost</label>
				<input type=""text"" class="form-control" id="exampleInputPassword1" placeholder="Cost"  name="Maintenance_Cost" value="<%=repairandmaintenance.getMaintenance_Cost()%>" required><br>
				
				
				
				<input type="submit" class="btn btn-success "  value="Update"  style="margin-left:500px;"><br>
	</form><br><br>
